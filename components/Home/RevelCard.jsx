...
function RevealCard({ title, description, image, demoLink, bgGradient }) {
  return (
    <div className="relative w-[350px] h-[400px] mx-auto bg-primary rounded-[15px] hover:shadow-[0_15px_60px_rgba(0,0,0,0.5)] group overflow-hidden">
